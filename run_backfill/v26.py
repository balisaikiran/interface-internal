...
STATE_FILE = 'pagination_state_sai.json'
RETRY_LIMIT = 5
RETRY_DELAY = 5  # in seconds
API_KEY = 'fka_1efHhLHOvvrDo79BhaeAm2vsv0Ddy2gxIv'  # Replace with your actual API key
...
def load_state():
    if os.path.exists(STATE_FILE):
        with open(STATE_FILE, 'r') as file:
            ...
            return state.get('nextLink', None), state.get('page_number', 5000)
    return None, 0
