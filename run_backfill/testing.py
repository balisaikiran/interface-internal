...
def method_type(action):
    # Define your method_type function here based on your requirements
    if action == "edit-client":
        return "/v1/edit_client/"
    # Add other cases as needed

def post_request(payload):
    # Define your post_request function here to send HTTP requests to the Sisu API
    response = requests.post(
        url + method_url,
        headers=headers,
...
def process_message(message_body):
    ...
    for opp in opps:
        ...
        if sisu_client_id:
            ...
            print("Sisu client response:", sisu_client_response)
