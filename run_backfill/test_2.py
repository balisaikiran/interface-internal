...
def fetch_custom_fields():
    url = 'https://api.followupboss.com/v1/customFields?next=eyJzaW5jZUlkIjoxNTZ9'
...
def get_contact(contact_id):
    url = f'https://api.followupboss.com/v1/people/{contact_id}?custom=true'
    auth = HTTPBasicAuth(API_KEY, '')
...
if custom_fields:
    # Now fetch the contact details with custom fields
